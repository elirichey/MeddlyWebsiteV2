...
export default function AccountLayout({ children }: Props) {
	// Page Metadata
	const title = 'Meddly | Account';
	const description =
		'Record every event with Meddly. Capture, package, and release complete recordings of every event on Meddly.';
	...
	return (
		<html lang="en">
			...
			<body className={`${redhat.variable} ${logo.variable} font-sans`}>
				<Header />
				<div className={`base ${redhat.variable} ${logo.variable} font-sans`}>{children}</div>
				<Footer />
