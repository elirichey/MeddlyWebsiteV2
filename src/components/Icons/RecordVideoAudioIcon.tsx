...
const RecordVideoAudioIcon = ({ className }: Props) => {
	return (
		<svg viewBox="0 0 16 16" className={className} aria-label="record-video-audio-icon" role="img">
...
export default RecordVideoAudioIcon;
