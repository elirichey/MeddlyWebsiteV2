...
const WifiIcon = ({ className }: Props) => {
	return (
		<svg viewBox="0 0 16 16" className={className} aria-label="wifi-icon" role="img">
			<path
				d="M15.4,6.1c0.2-0.2,0.2-0.6,0-0.7C13.3,3.9,10.7,3,8,3C5.3,3,2.7,3.9,0.7,5.4c-0.2,0.2-0.3,0.5,0,0.7c0.2,0.2,0.5,0.2,0.7,0
